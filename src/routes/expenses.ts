 ...
 * @access  Public
 * @query   ?isDebit=boolean&dateFrom=date&dateTo=date&amountMin=number&amountMax=number&search=string&Account_Id=number&Person_Id=number&page=number&limit=number&sortBy=string&sortOrder=asc|desc
 */
 ...
 * @access  Public
 * @query   ?isDebit=boolean&dateFrom=date&dateTo=date&amountMin=number&amountMax=number&search=string&Account_Id=number&Person_Id=number
 */
 ...
 * @access  Public
 * @query   ?amountMin=number&amountMax=number&search=string&Account_Id=number&Person_Id=number
 */
router.get(
  "/type-summary",
